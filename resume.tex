...
\item Distributes, performs quality control and enhances advanced statistical
    ...
    unsupervised learning, Python, continuous integration, Pytorch, SciPy,
    Plotly).
...
\item Contributes to the development of software infrastructure to record,
    ...
    dahsboard, interactive visualization, data acquisition, experimental
...
\par
\vspace{2\baselineskip}
{\bf University College London} \hspace*{\fill} January 2023 --
\marginpar{{\bf Teaching}}
\par
{\bf Course}: Neuroinformatics (NEURO019)
\marginpar{{\bf Experience}}
\par
